...
class Ball {
  ...
  Ball(float widthParameter, float heightParameter) { //Passing Geometry
    ...
    ballDiameter = int(widthParameter/50); //Will soon need a procedure for this or a choice of code'
